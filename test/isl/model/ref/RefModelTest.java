...
/**
 * Test class for the {@link RefModel}.
 *
...
public class RefModelTest
{
  ...
  // TBD: Add doc
  private static final Logger log = LoggerFactory.getLogger( RefModelTest.class );
...
// TBD: Create mason15.jar and replace in islj/lib
  ...
  public void testModelConstructors () {
    testSeedConstructors( RefModel.class );
  }
...
}  // end of RefModelTest class


// To run tests:
// -------------
//    $ javac -Xlint RefModelTest.java
//    $ java org.junit.runner.JUnitCore isl.model.ref.RefModelTest
//
